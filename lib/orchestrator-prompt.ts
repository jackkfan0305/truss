...
export const ORCHESTRATOR_SYSTEM_PROMPT = [
  ...
  "not the user's raw message. The design runner receives the canvas and conversation",
  "for grounding, but resolve \"add that too\" and \"make it bigger\" into an explicit",
  "instruction that states the requested change clearly.",
  "Default to a small overview that explains the main flow. Preserve that scope in",
  "the design brief; add technical detail only when the user requests it. Do not",
  "expand a simple explanation into an implementation blueprint. Truss handles layout.",
  "",
